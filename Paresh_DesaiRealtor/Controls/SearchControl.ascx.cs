    ...
    public partial class SearchControl : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if ((Convert.ToString(Session["QueryString"]) == "Residential" || (Convert.ToString(Session["SearchType"]) == "Residential")) && (Session["Status"] == "" || Session["Status"] == null))
                {
                    SearchResidentialProperties();
                }

                else if ((Convert.ToString(Session["QueryString"]) == "Commercial" || (Convert.ToString(Session["SearchType"]) == "Commercial")) && (Session["Status"] == "" || Session["Status"] == null))
                {
                ...
                else if (Convert.ToString(Session["QueryString"]) == "Residential" || (Convert.ToString(Session["SearchType"]) == "Residential") && Session["Status"] == "Lease")
                    SearchResidentialProperties();
                else if ((Convert.ToString(Session["QueryString"]) == "Commercial" || (Convert.ToString(Session["SearchType"]) == "Commercial")) && Session["Status"].ToString() == "Lease")
                {
                    SearchCommercialProperties();
                }
        ...
        void SearchResidentialProperties()
        {
            try
            {
                ...
                if ((Convert.ToString(Session["QueryString"]) == "Residential" && Session["Municipality"] == null) && (Session["Status"] == "" || Session["Status"] == null))
                {
                    dt = mlsClient.GetResidentialProperties("0", "0", "0", "0", "0", "0", "0");
                }
                else if ((Convert.ToString(Session["QueryString"]) == "Residential" && Session["Municipality"] != "") && (Session["Status"] == "" || Session["Status"] == null))
                {
                    dt = mlsClient.GetResidentialProperties(Session["Municipality"].ToString(), "0", "0", "0", "0", "0", "0");
                }
                else if (Convert.ToString(Session["QueryString"]) == "Residential" && Session["Status"] != "")
                {
                    dt = mlsClient.GetResidentialProperties("0", keyword.ToString(), "0", "0", "0", "0", Session["Status"].ToString());
                }
        ...
        void SearchCommercialProperties()
        {
            try
            {
                ...
                Property1.MLSDataWebServiceSoapClient mlsClient = new Property1.MLSDataWebServiceSoapClient();
                DataTable dt = new DataTable();
                if (Convert.ToString(Session["QueryString"]) == "Commercial" && Session["Municipality"] == null && (Session["Status"] == "" || Session["Status"] == null))
                {
                    dt = mlsClient.GetAllCommercialProperties("0", "0", "0", "0", "0", "0");
                }
                else if (Convert.ToString(Session["QueryString"]) == "Commercial" && Session["Municipality"] != null && (Session["Status"] == "" || Session["Status"] == null))

                {
                    dt = mlsClient.GetAllCommercialProperties(Session["Municipality"].ToString(), "0", "0", "0", "0", "0");
                }
                else if (Convert.ToString(Session["QueryString"]) == "Commercial" && Session["Status"] != "")
                {
                    dt = mlsClient.GetAllCommercialProperties("0", "0", "0", "0", "0", Session["Status"].ToString());
                }
            ...
            try
            {
                ...
                if (Convert.ToString(Session["QueryString"]) == "Condo" && Session["Municipality"] == null)
                {
                    if (Session["Status"] != null && Session["Status"] != "")
                    {
                        ...
                        dt = mlsClient.GetProperties_Condo("0", "0", "0", "0", "0", "0", Session["Status"].ToString());
                    }
                    else
                    {
