    ...
    public partial class PropertyNew : System.Web.UI.MasterPage
    {
        ...
        private void BindMenusList()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                StrMenu.Append("<li>");
                StrMenu.Append("<a href='#' title='Lease properties'>Lease properties</a>");
                StrMenu.Append("<ul >");
                StrMenu.Append("<li>");
                StrMenu.Append("<a href='../PropertyType.aspx?Status=Lease&PropertyType=Residential' title='Lease properties'>Residential lease properties</a>");
                StrMenu.Append("</li>");
                StrMenu.Append("<li>");
                StrMenu.Append("<a href='../Search.aspx?Status=Lease&PropertyType=Commercial' title='Lease properties'>Commercial lease properties</a>");
                StrMenu.Append("</li>");
                StrMenu.Append("</ul >");
                StrMenu.Append("</li>");
