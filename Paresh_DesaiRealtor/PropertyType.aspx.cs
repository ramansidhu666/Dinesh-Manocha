...
namespace Property
{
    public partial class PropertyType : System.Web.UI.Page
    {
        ...
        {
            this.Page.Title = "Dinesh Manocha : Home";
        ...
        void SearchResidentialProperties(string ptype)
        {
            try
            {
                ...
                //string s = dt.Rows[0]["RemarksForClients"].ToString();
                    ...
                    hlresi1.NavigateUrl = "../Search.aspx?Status=" + Session["Status"].ToString() + "&PropertyType=" + ptype + "&keyword=detached";

                //string s1 = dt.Rows[1]["RemarksForClients"].ToString();

                imgresi2.ImageUrl =  "images/semi_detached.jpg";
                hlresi2.NavigateUrl = "../Search.aspx?Status=" + Session["Status"].ToString() + "&PropertyType=" + ptype + "&keyword=semi-detached";
                //string s2 = dt.Rows[2]["RemarksForClients"].ToString();

                imgresi3.ImageUrl = "images/condo_img.jpg" ;
                hlresi3.NavigateUrl = "../Search.aspx?Status=" + Session["Status"].ToString() + "&PropertyType=Condo";
